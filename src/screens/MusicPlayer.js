...
const MusicPlayer = () => {
  ...
  const [likedMode, setLikedMode] = useState('heart-outline');
...
const changeLikedMode = ()=>{
    if (likedMode == 'heart-outline') {
        setLikedMode('heart')
}
if (likedMode == 'heart') {
    setLikedMode('heart-outline')
}
}
    ...
    <SafeAreaView style={style.container}>
      ...
      <View style={style.mainContainer}>
        ...
        <View>
          <Text style={[style.songContent, style.songTitle]}>
             ...
             {/* {musicData[songIndex].title}  */}
            {trackTitle}
            
          </Text>
          <Text style={[style.songContent, style.songArtist]}>
            
             {/* {musicData[songIndex].artist} */}
             {trackArtist}
      ...
      <View style={style.bottomSection}>
        <View style={style.bottomIconContainer}>
          <TouchableOpacity onPress={changeLikedMode}>
            <Ionicons name={`${liked()}`} size={30} color={likedMode !== "heart" ?'#FFD369' : '#888888' } />
          </TouchableOpacity>
